...
/** 
 * Similar to the FastDiscreteModelCalculator
 * Likelihood models based on finite state CTMC of GTR+I+Gamma.
 ...
 */
public final class FastDiscreteModelCalculator4GTRIGamma implements LikelihoodModelCalculator, Serializable 
{
  ...
  public static FastDiscreteModelCalculator4GTRIGamma observation(CTMC ctmc, double [][] initCache)
  {    
    return new FastDiscreteModelCalculator4GTRIGamma(initCache, ctmc, false);
  }
...
//  }
  ...
  public static FastDiscreteModelCalculator4GTRIGamma observation(CTMC ctmc, double [][] initCache, boolean resampleRoot)
  {    
    return new FastDiscreteModelCalculator4GTRIGamma(initCache, ctmc, resampleRoot);
  }
...
//  private final DiscreteModelCalculator tester;
  ...
  private FastDiscreteModelCalculator4GTRIGamma(double[][] cache, CTMC ctmc,
...
//    this.resampleRoot = resampleRoot;
  ...
  private FastDiscreteModelCalculator4GTRIGamma(double[][] cache, CTMC ctmc, boolean resampleRoot) //, double [] itemizedLogLikelihoods) // call this if you are initializing !
  {
    if (resampleRoot)
...
//          itemized[s] += term;
  ...
  {
    final FastDiscreteModelCalculator4GTRIGamma 
    cache1 = (FastDiscreteModelCalculator4GTRIGamma) (node1),
    cache2 = (FastDiscreteModelCalculator4GTRIGamma) (node2);
...
//    MathUtils.checkClose(newLogLikelihood, dmc.logLikelihood());
    ...
    if (isPeek) return newLogLikelihood;
                                      ...
                                      new FastDiscreteModelCalculator4GTRIGamma(result, ctmc, newLogLikelihood, false); 
//        dmc);
  }
