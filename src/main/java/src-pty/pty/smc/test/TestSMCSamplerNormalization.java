...
import pty.smc.ParticleFilterSMCSampler.ResamplingStrategy;

public class TestSMCSamplerNormalization
{
  ...
  public static void main(String [] args)
  {
    ...
    ParticleProcessor voidPro = new ParticleFilterSMCSampler.DoNothingProcessor();
//    ParticleFilter pf = new ParticleFilter();
    
    ParticleFilterSMCSampler pf = new ParticleFilterSMCSampler();
    pf.N = 50000;
